...
fn pooling(
    ...
    # changing to explicitly test for 0 and 1 like the solution does... 
    # I'm curious about this kind of windowing when you need data 
    # from memory other block's memory boundaries/segments... 
